...
| 特性 | 说明 |
|------|------|
| 🪟 **毛玻璃设计** | Glassmorphism 视觉风格，支持深色/浅色主题自动切换 |
| 🏠 **替换新标签页** | 安装即用，打开新标签页就是你的书签 |
| 📂 **分组展示** | 按 Chrome 书签文件夹自动分组，清晰明了 |
| 📌 **快速访问** | 一级书签固定在顶部，一键直达 |
| 🔍 **实时搜索** | 输入即搜，高亮匹配结果 |
| 🖼️ **悬浮预览** | 鼠标悬停分组卡片，大尺寸预览窗展示全部书签 |
| 🎨 **背景自定义** | 6 种渐变预设 + 自定义图片背景 |
| 🌙 **深色/浅色** | 跟随系统或手动切换 |
| ✏️ **编辑模式** | 在界面上直接编辑、删除、拖动排序书签和分组 |
...
> 💡 通过开发者模式本地加载即可使用，无需发布到 Chrome 应用商店。

### 📥 第一步：下载源码

<details>
<summary><b>方式 A — Git 克隆（推荐，方便后续更新）</b></summary>
